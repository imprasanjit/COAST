...
public class ReportRepositoryCustomImpl implements ReportRepositoryCustom {
	...
	@Override
	public List<Tehsil_summary> getTehsilLandSummary(String district) {
		String jpql = "select distname,tehname,totalgovtland,gvtlndnotconsidered,gvtfeslndconsidered,aqpondarea,reglndinfeslnd"
				+ " ,commonreglandaquawithinfeasiblelnd,feslndutilised,availablefeslnd from coast_oltp.tehsil_sumary where distname='" + district + "'  order by distname";
		Query queryy = entityManager.createNativeQuery(jpql);
	...
	@Override
	public List<Village_Summary> getVillageareasummary(String district) {
		String jpql = "select dist_name,teh_name,vill_name,total_govtLand,gvtlnd_notconsidered,gvtfeslnd_considered,aqpond_area,reglnd_in_feslnd"
				+ " ,common_regland_aqua_within_feasiblelnd,feslnd_utilised,available_feslnd from coast_oltp.vill_summary_table where dist_name='"+district+"' order by dist_name";
		Query queryy = entityManager.createNativeQuery(jpql);
