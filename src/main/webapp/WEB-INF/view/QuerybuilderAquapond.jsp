<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %>
    <%@ taglib uri="http://www.springframework.org/tags" prefix="spring" %>
        <%@ taglib uri="http://www.springframework.org/tags/form" prefix="form" %>
            ...
            <div class="page-loader" id="loaderdiv" style="display: none"><img src="<spring:url value="
                    /images/loader.gif" />"alt="loader" /></div>
            ...
            <div class="content-page content-custom">
                                    ...
                                    <div class="card" style="margin-bottom:0px">
                                        <div class="card-body" style="padding:1.25rem">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-2">
                                                    <select class="form-control custom-select" id="ddlgp" name="ddlgp"
                                                        onchange="bindvillage(this.value)">
                                                        <option>-- Select --</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <label id="lbllndtype" for="" class="col-sm-2 col-form-label">Aqua Theme
                                                    Queries</label>                                       
                                                <div class="col-sm-3" id="divlndtype">
                                                <select class="form-control custom-select" id="ddllandtype">

                                                    <option value="areaac=gfac">Aqua-ponds fully in govt-feasible land</option>
                                                    <option value="areaac > gfac and gfac > 0">Aqua-ponds Partially in govt-feasible land</option>
                                                    <option value="licensed='Yes'">Aqua-ponds in Registered Farmland</option>
                                                    <option value="licensed='No'">Aqua-ponds outside Registered Farmland</option>
                                                    <option value="licensed='Yes' and gfac > 0">Registered Aqua-ponds in Govt.Feasible land</option>
                                                    <option value="licensed='Yes' and gnfac > 0">Registered Aqua-ponds in Govt.Non-Feasible land</option>
                                                    <option value="crzaac =0">Aqua-ponds outside CRZ</option>
                                                    <option value="crzaac >0">Aqua-ponds inside CRZ</option>
                                                    <option value="pondno>0">ALL Aquaponds</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group row" id="serchdiv" style="display:none">
                                            ...
                                            <div class="col-sm-2">
                                                <input class="form-control text-box single-line" id="searchtext"
                                                    placeholder="Plot No." required="required" type="text" value="">
                                            </div>
                                        </div>
                                        <hr>
                ...
                <div class="row mt-2" id="showLtlDiv">
                    <div class="col-xl-12 text-center">
                        <a style="display:none" id="showLtl" class="btn btn-sm btn-success" data-toggle="collapse"
                        ...
                        <div class="card">
                            <div class="card-body card-body-custom">
                                <ul class="nav nav-tabs" role="tablist">
                                    <li class="nav-item"><a class="nav-link tab1 active" data-toggle="tab" href="#tab1"
                                            role="tab"><i class="ti-map-alt"></i> &nbsp;Map View &nbsp;</a></li>
                                    <li class="nav-item"><a class="nav-link tab2" data-toggle="tab" href="#tab2"
                                            role="tab"><i class="mdi mdi-menu"></i> &nbsp;STATISTICS</a></li>
                                    <li class="nav-item mt-2 ml-4"><span id="result"
                                            class="badge badge-info font-13"></span></li>
                                </ul>
                                <div class="tab-content p-3-side">
                                    <div class="tab-pane active p-1" id="tab1" role="tabpanel">
                                        <div id="map" class="fixHeightLeft" width="100%" height="100%"
                                            style="border:0;position:relative;height:calc(100vh - 215px)">
                                        ...
                                        <div id="mySwitcher" class="switcher">
                                            <a href="javascript:void(0)" class="closebtn btn btn-sm btn-danger"
                                                    ...
                                                    <div class="card-body" style="padding:10px">
                                                        <div id="accordion" class="mapFilter">
                                                            <a id="layerDiv" href="#collapseOne" class="text-dark"
                                                                ...
                                                                <span class="d-block font-12"><img
                                                                        src="<spring:url value="
                                                                        /images/icon-layers.png" />"
                                                                    style="width:12px">&nbsp;Layers</span>
                                                            </a>

                                                            <a id="measureDiv" href="#collapseFour"
                                                                class="text-dark collapsed" data-toggle="collapse"
                                                                aria-expanded="false" aria-controls="collapseFour">
                                                                <span class="d-block font-12"><img
                                                                        src="<spring:url value="
                                                                        /images/icon-measurement.png" />"
                                                                    ...
                                                                    <div class="fixHeightRight">
                                                                        ...
                                                                        <div class="card-body">
	                                                                        ...
	                                                                        <div id="collapse12" class="collapse" aria-labelledby="heading12" data-parent="#accordion3">
                                                                             ...
                                                                             <a id="layerDiv4k" href="#collapse6" class="text-dark collapsed" data-toggle="collapse" aria-expanded="false" aria-controls="collapse6">
	                                                                                ...
	                                                                                <div class="form-group-sm row">
                                                                                        ...
                                                                                        <div id="collapse7"
                                                                                            ...
                                                                                            <form
                                                                                                ...
                                                                                                action="">
                                                                                                <div
                                                                                                    class="form-group-sm row">
                                                                                                    <div
                                                                                                        class="custom-control custom-checkbox">
                                                                                                        <input
                                                                                                            type="checkbox"
                                                                                                            id="chkbalpnd" />Baleswar
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div
                                                                                                    class="form-group-sm row">
                                                                                            ...
                                                                                            <form
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <input
                                                                                                            type="checkbox"
                                                                                                            id="chkfarmjagatsinghpur" />Jagatsinghpur
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div
                                                                                                    class="form-group-sm row">
                                                                                                    <div
                                                                                                        ...
                                                                                                        <input
                                                                                                            type="checkbox"
                                                                                                            id="chkfarmkendrapara" />Kendrapada
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div
                                                                                                    class="form-group-sm row">
                                        ...
                                        <span class="switcherMenu btn btn-sm btn-dark"
                                            onclick="openNav()">L<br>a<br>y<br>e<br>r<br>s</span>
                                        ...
                                        <div id="mySwitcher2" class="switcher2">
                                            ...
                                            <div class="btn-selector">
                                                <button id="terrain" type="button"
                                                    class="btn btn-sm btn-success waves-effect waves-light"><img
                                                        src="<spring:url value=" /images/icon-terrain.png" />"
                                                    width="20px">&nbsp;Terrain</button>
                                                <button id="osm" type="button"
                                                    class="btn btn-sm btn-success waves-effect waves-light"><img
                                                        src="<spring:url value=" /images/icon-satellite.png" />"
                                                    width="20px">&nbsp;Satellite</button>
                                                <button id="cartography" type="button"
                                                    class="btn btn-sm btn-success waves-effect waves-light"><img
                                                        src="<spring:url value=" /images/icon-cartography.png" />"
                                                    width="20px">&nbsp;Map View</button>
                                                <button id="bingmap" type="button"
                                                    class="btn btn-sm btn-success waves-effect waves-light"><img
                                                        src="<spring:url value=" /images/icon-cartography.png" />"
                                                    width="20px">&nbsp;Bing Map</button>
                                            </div>
                                        </div>
                                        ...
                                        <span class="switcherMenu3 btn btn-sm btn-dark"
                                            onclick="openNav3()">L<br>e<br>g<br>e<br>n<br>d</span>

                                    </div>
                                    <div class="tab-pane p-3" id="tab2" role="tabpanel">
                                        <button id="pdf" type="button"
                                            class="btn btn-sm btn-danger waves-effect waves-light mb-2"><i
                                                class="fas fa-file-pdf"></i></button>
                                        <button id="csv" type="button"
                                            class="btn btn-sm btn-success waves-effect waves-light mb-2"><i
                                                class="fas fa-file-excel"></i></button>
                                        <button id="print" type="button"
                                            class="btn btn-sm btn-warning waves-effect waves-light mb-2"><i
                                                class="fas fa-print"></i></button>
										<h6>Existing Aquapond Search Statistics</h6>
                                        <div class="table-responsive" id="tblprint"
                                            style="height:400px;overflow-y:scroll">
                                            
                                            <table id="myData" class="table table-striped table-bordered nowrap"
            ...
            <script
                src="https://rawgit.com/simonbengtsson/jsPDF-AutoTable/master/dist/jspdf.plugin.autotable.js"></script>  
        ...
        $("#chkgvtjaj").change(function () {
            ...
            if (this.checked) {
              ...
              //CRZ Information
                                     ...
                                     success: function (data) {
                                         ...
                                         $.each(data, function (i, item1) {
                                             ...
                                             var rows = "<tr>" +
                                                 ...
                                                 "<td>" + item1[0] + "</td>" +
                                                 "<td>" + item1[1] + "</td>" +
                                                 "<td>" + ((item1[2] == null) ? " " : item1[2]) + "</td>" +
                                                 "<td>" + ((item1[3] == null) ? " " : item1[3]) + "</td>" +
                                                 "<td>" + Math.round(item1[4]) + "</td>" +
                                                 "<td>" + ((item1[5] == null) ? " " : item1[5]) + "</td>" +
                                                 "<td>" + item1[6] + "</td>" +
                                                 "<td>" + item1[7] + "</td>" +
                                                 "<td>" + item1[8] + "</td>" +
                                                 "<td>" + item1[9] + "</td>" +
                                                 "<td>" + item1[10] + "</td>" +
                                                 "<td class='hiddata'><div class='dropdown'><a class='dropdown-toggle' id='dropdownMenuButton' data-toggle='dropdown' aria-haspopup='true' aria-expanded='false'><i class='fa fa-cog'></i></a> <div class='dropdown-menu' aria-labelledby='dropdownMenuButton'><a data-toggle='tab' href='#tab1' role='tab' value=" + item1[4] + " onclick='return MapPlot(" + item1[4] + ","+item1[6]+")' class='dropdown-item nav-link'>View in Map</a><a href='' onclick='loadDoc()' class='dropdown-item'>Download KML </a></div></div></td>" +
                                                 "</tr>";
                                             $('.tbody').append(rows);
                                         });
                                         rows = '<tr><td></td><td></td><td></td><td></td><td></td><td></td><td><b>Total</b></td><td id="sum1"></td><td id="sum2"></td><td id="sum3"></td><td></td><td></td><td></td></tr>';
                                         //$('#myData tbody').empty();
                ...
                function MapPlot(pond_no, gis_area){  
                        ...
                        if ($('#ddltehesil').val() != 'ALL') {
							if ($('#ddlgp').val() != 'ALL') {
                                if ($('#ddlvillage').val() != 'ALL') {
                                	if ($('#txtplotno').val() != "") {
                                        plotZoomLayer(pond);
                                        bindecoinfowindow(plot_current_layer,'','',pond,gis_area);
                                   }
                                	else {
            ...
            var dist_current_layer,tehsil_current_layer,gp_current_layer,vill_current_layer,plot_current_layer;
                ...
                function plotZoomLayer(pond) {
                    var vectorSource = new ol.source.Vector();
                    var styles =new ol.style.Style({
                         stroke : new ol.style.Stroke({
                  				color : 'rgb(213, 235, 52)',
                  				width : 3,
                                 //lineDash: [.1, 5] //or other combinations
                                }),
                                //zIndex: 2,
                    ...
                    var param='dist='+$('#ddldist').val()+'&tehsil='+$('#ddltehesil').val()+'&gp='+$('#ddlgp').val()+'&vill='+$('#ddlvillage').val()+'&pondno='+pond;
                  	fetch('/geojson/getAquaPondInfoGeoJson?'+param, {
                  		method : 'GET',
                  	}).then(function(response) {
                  		return response.json();
                  	}).then(function(json) {
                ...
                function bindecoinfowindow(layer, p, n,pond,gis_area){
