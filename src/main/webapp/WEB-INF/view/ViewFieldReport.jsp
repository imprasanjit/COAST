...
<div class="content-page">
    <div class="container-fluid">
        <div class="page-title-box">
            <div class="row align-items-center">
                <div class="col-sm-6">
                    <h4 class="page-title">View Field Reporting</h4>
                    <input type="hidden" value="" id="hfName" name="Name" />
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active">Field Reporting</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-group row mb-0">
                            <label for="" class="col-sm-1 col-form-label">District</label>
                            <div class="col-sm-2">
                                <select class="form-control custom-select" id="ddldist" name="ddldist" onchange="onchangeddldistrict(this.value)">
                                        <option value="ALL">ALL</option>
                                        <option value="Baleshwar">Baleshwar</option>
                                        <option value="Bhadrak">Bhadrak</option>
                                        <option value="Cuttack">Cuttack</option>
                                        <option value="Ganjam">Ganjam</option>
                                        <option value="Jajapur">Jajpur</option>
                            ...
                            <label for="" class="col-sm-1 col-form-label" id="lbltehsil">Tehsil</label>
                            <div class="col-sm-2 mb-2" id="divtehsil">
                                <select class="form-control custom-select" id="ddltehesil" name="ddltehesil" onchange="bindgp(this.value)">
                                    <option value="">--Select--</option>
                                </select>
                            </div>
                            <label for="" class="col-sm-1 col-form-label" id="lbltehsil">GP</label>
                            <div class="col-sm-2 mb-2" id="divtehsil">
                                <select class="form-control custom-select" id="ddlgp" name="ddlgp" onchange="bindvillage(this.value)">
                                    <option value="">--Select--</option>
                                </select>                                
                            </div>
                            <label for="" class="col-sm-1 col-form-label" id="lbltehsil">Village</label>
                            <div class="col-sm-2 mb-2" id="divtehsil">
                                <select class="form-control custom-select" id="ddlvillage" name="ddlvillage" onchange="bindplotno(this.value)">
                                    <option value="">--Select--</option>
                                </select>                                
                            </div>
                        </div>                        
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-sm-12 text-center">
                                <input type="submit" id="sub" value="Submit" class="btn btn-success waves-effect waves-light">
                            </div>
                        </div>
                    </div> 
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <ul class="nav nav-tabs" role="tablist" id="myTab">
                            ...
                            <li class="nav-item"><a class="nav-link tab2" data-toggle="tab" href="#tab2" role="tab"><i class="mdi mdi-menu"></i> &nbsp;Survey Data</a></li>
                            <li class="nav-item" style="line-height:40px;margin-left:10px;min-width:350px"><span id="myposition"><strong style="float:left;color:#2791b3">Mouse Position :&nbsp;</strong></span></li>
                        </ul>
                        <div class="tab-content p-3-side">
                            <div class="tab-pane active pt-2 pl-3 pr-3 pb-2" id="tab1" role="tabpanel">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="custom-floating-form">
                                            <input id="lat" class="floating-input" type="text" placeholder="Latitude">
                                            <input id="lon" class="floating-input" type="text" placeholder="Longitude">
                                            <input id="lon" class="floating-input" type="button" onclick="addpoint()" value="show">
                                        </div>
                            ...
                            <div class="btn-selector">
                                <button id="terrian" type="button" class="btn btn-sm btn-success waves-effect waves-light"><img src="<spring:url value="/images/icon-terrain.png"/>" width="20px">&nbsp;Terrain</button>
                                                                        ...
                                                                        <div id="legendDiv" class="widget-main">
                                                                            <h6 class="mt-2 header-title mb-2" id="icon_admin_heading">Administrative Boundaries</h6>
	                                                                            <span id="icon_district_boundary" style="" class="legend-text-style"><img src="<spring:url value="/images/icon-district-boundary.jpg"/>" /></span> 
						                                                                            ...
						                                                                            <span id="icon_asi" style="" class="legend-text-style"><img src="<spring:url value="/images/icon-asi.jpg"/>" /></span><br/>                          </div>
                                                                    </div>
                                                                </div>
                                                            </form>
                                                        </div>
                            ...
                            <div class="tab-pane pt-2 pl-3 pr-3 pb-2" id="tab2" role="tabpanel">
                                <div class="row">
                                    <div class="col-lg-12">
                                            ...
                                            <table id="myData" class="table table-striped table-bordered nowrap" style="border-collapse:collapse;border-spacing:0;width:100%">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>Latitude</th>
                                                        <th>Longitude</th>
                                                        <th class="custom-hide">ViewMap</th>
                                                    </tr>
                                                    <tr id="noRecordTR" style="display:none"> 
                  										<td>No Record Found</td>                              
  													</tr>
                                                </thead>
                                                <tbody class="tbody" id="tbd"></tbody>
                                            </table>
   ...
   <script src="https://openlayers.org/en/v4.6.5/build/ol-debug.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        function onchangeddldistrict(distname) {
        		if(distname!="ALL"){
        				$.ajax({
...
var gpboundary = new ol.layer.Image({
    source: new ol.source.ImageWMS({
        url: baseURLWMS,
        params: {
...
var map = new ol.Map({
    layers: [baselayer, carto, raster,bingMap, vectorLayer, stateboundarylayer, distlayer, tehesil,gplayer,villstdylayer,
        ...
        caaboundary, HTL,CRZ ,fiftymtr_crz1a,crz_ia,crz_ib,crz_ii_area,htl_200m_500m,Fish_land_centre,jetties,light_house,port,Fishharbour,mcs,ecoasi, Bird_Nesting_Ground, Horseshoe_Crab, Mangroves_lyr, Marine_Protected_Area, Mudflats, Reserve_Forest, Salt_Marshes, Sand_Dunes, Sea_Grass, Turtle_Nesting_Ground,
        majorloc],
...
//Cartography basemap Checkbox Change Event
...
map.addInteraction(selectSingleClick);
        ...
        /*  else{
        	 if(t=="ALL"){
            	 ...
            	 //else{
            		 $.ajax({
                         url:"/getsurveydata/",
                         data : {'village' : $('#ddlvillage option:selected').val(),            	
            					'gp' : $('#ddlgp option:selected').val(),
            					'dist' : $('#ddldist option:selected').val(),
            					'tehsil' : $('#ddltehesil option:selected').val()
            			         },
                         type: "GET",
                         contentType: "application/json;charset=utf-8",
                         dataType: "json",
            			 success: function (data) {
            	                ...
            	                // var html = '';
            	                 ...
            	                 $.each(data, function (i, item1) {              
            	                 	var rows = "<tr>"
            	                 		+"<td>" + parseFloat(sl++)+ "</td>" 
            	                 		+ "<td>" + item1[0].toString()+ "</td>" 
            	                 		+ "<td>" + item1[1]+ "</td>" 
            	                 		+ "<td>" + item1[2]+ "</td>" 
            	                 		+ "<td>" + item1[3]+ "</td>" 
            	                 		+ "<td>" + item1[4]+ "</td>"
            	                 		+ "<td class='hiddata'><a data-toggle='tab' href='#' onclick='return photoFile("+ JSON.stringify(item1[5]) +")' class='nav-link btn-sm btn-success waves-effect waves-light'><i class='fa fa-eye'></i></a></td>"
            	                 		+ "<td>" + item1[6]+ "</td>" 
            	                 		+ "<td>" + item1[7]+ "</td>" 
            	                 		+ "<td>" + item1[8]+ "</td>"
            	                 		+ "<td class='hiddata'> <a data-toggle='tab' href='#tab1' role='tab'  onclick='return MapPlot("+ JSON.stringify(item1[0]) +","+JSON.stringify(item1[1])+","+ JSON.stringify(item1[2])+","+ JSON.stringify(item1[3])+","+ JSON.stringify(item1[6])+","+ item1[7] +","+ item1[8] + ")' class='nav-link btn-sm btn-success waves-effect waves-light'><i class='fa fa-eye'></i></a></td>";
            	                 		+"</tr>";
            	             	...
            	             	//$('.tbody').append(rows);
            					//tablesum();
            	                //rows = '<tr><td></td><td></td><td></td><td><b>Total</b></td><td id="sum1"></td><td id="sum2"></td><td id="sum3"></td></tr>';               
            	                 //$('.tbody').html(html);
            	                var a = data.length;
   ...
   function MapPlot(distname,tehname,gpname,villname,remarks,lat,lon) {
       ...
       map.on('click', function (evt){
    	   ...
    	   bindecoinfowindow(plot_current_layer,[distname,tehname,gpname,villname],["Distname","Tehname","gpname","villname"],evt);
       });
       //bindecoinfowindow(lp,[""],[""]);
   }
		...
		fetch('/geojson/getGpJson?'+param, {
	 		...
	 		return response.json();
	  		...
	  		var vectorLayer = new ol.layer.Vector({
		  		source : vectorSource,
		  		style: function() {
                    styles.getText().setText($('#ddlgp').val());
                    return styles;
                  },
		  	});
	  		var features =gjFormat.readFeatures(json.geojson);
