...
<div class="content-page content-custom">
                            ...
                            <div class="card-body" style="padding:1.25rem">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <option value="Khurda">Khurdha</option>
                                ...
                                <div class="form-group row">   
                                    ...
                                    <label id="lbllndtype" for="" class="col-sm-2 col-form-label">Registered Aqua-Farm Queries</label>
                                    <div class="col-sm-3" id="divlndtype">
                                        <select class="form-control custom-select" id="ddllandtype">
                                            
                                            <option value="status='Active' and glac>0">Registered Aqua-Farm In Government Land</option>
                                            <option value="apexist='Yes'">Registered Aqua-Farm Having Aqua-Pond</option>
                                            <option value="apexist='No'">Registered Aqua-Farm Not Having Aqua-Pond</option>
                                            <option value="status='Active'">Registered Aqua-Farm Having Active Status</option>
                                            <option value="status='Not Renewed'">Registered Aqua-Farm Having InActive Status</option>
                                        </select>
                                    </div>
                                </div>
                    ...
                    <div class="card-body card-body-custom">
                                                                    ...
                                                                    <div id="accordion3">
                                                                     <a id="layerDivprivate4kclip" href="#collapse12" class="text-dark collapsed" data-toggle="collapse" aria-expanded="false" aria-controls="collapse12">
                                                                       ...
                                                                       <a id="layerDivprivate4k" href="#collapse12" class="text-dark collapsed" data-toggle="collapse" aria-expanded="false" aria-controls="collapse12">
                                                                        ...
                                                                        <a id="layerDivAcqPond" href="#collapse7" class="text-dark collapsed" data-toggle="collapse" aria-expanded="false" aria-controls="collapse7">
                                                                        ...
                                                                        <a id="layerDiv" href="#collapse9" class="text-dark collapsed" data-toggle="collapse" aria-expanded="false" aria-controls="collapse9">
                                                                        ...
                                                                        <a id="layerDiv" href="#collapse11" class="text-dark collapsed" data-toggle="collapse" aria-expanded="false" aria-controls="collapse11">
                        ...
                        <span class="switcherMenu3 btn btn-sm btn-dark" onclick="openNav3()">L<br>e<br>g<br>e<br>n<br>d</span>
							...
							<div class="tab-pane p-3" id="tab2" role="tabpanel">
								...
								<h6>Registered Aqua pond Search Statistics</h6>
									...
									<table id="myData"
										...
										<thead>
											<tr>
												...
												<th>Status</th>
												<th>Avl.Area(ac.)</th>
												<th>Aqua Pond Area(ac.)</th>
												<th>Govt.Land Area(ac.)</th>
    ...
    <script src="https://rawgit.com/simonbengtsson/jsPDF-AutoTable/master/dist/jspdf.plugin.autotable.js"></script>s 
        ...
        $("#btnsubmit").click(function () {
                         ...
                         success: function (data) {
                             ...
                             $.each(data, function (i, item1) {
                                 ...
                                 var rows = "<tr>" +
                                     ...
                                     "<td>" + item1[8] + "</td>" +
                                     "<td>" + item1[9] + "</td>" +
                                     "<td class='hiddata'><div class='dropdown'><a class='dropdown-toggle' id='dropdownMenuButton' data-toggle='dropdown' aria-haspopup='true' aria-expanded='false'><i class='fa fa-cog'></i></a> <div class='dropdown-menu' aria-labelledby='dropdownMenuButton'><a data-toggle='tab' href='#tab1' role='tab' value=" + item1[4] + " onclick='return MapPlot(" + item1[4] + ","+ item1[7] +")' class='dropdown-item nav-link'>View in Map</a><a href='' onclick='loadDoc()' class='dropdown-item'>Download KML </a></div></div></td>" +
                                     //"<td><a class='nav-link' data-toggle='tab' href='#tab1' role='tab' value=" + item1.pondnum + " onclick='return MapPlot(" + item1.pondnum + ")'><i class='fas fa-map-marked-alt'></i></a></td>" +
                                     "</tr>";
                                 $('#myData tbody').append(rows);                       
                             });
                             rows = '<tr><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td><b>Total</b></td><td id="sum1"></td><td id="sum2"></td><td id="sum3"></td><td></td></tr>';
         ...
         function tablesum() {
             ...
             $("#myData tr").not(':first').not(':last').each(function () {
                 sum1 += parseFloat($(this).find("td:eq(8)").text());
                 sum2 += parseFloat($(this).find("td:eq(9)").text());
                 sum3 += parseFloat($(this).find("td:eq(10)").text());
             });
...
/*         function bindecoinfowindow(layer, p, n,gis_area){
    	     ...
    	     if(layer==plot_current_layer){
    		     ...
    		     map.on('click', function (evt) 
    		     {
    	                   ...
    	                   //console.log(lon);
    	                   //console.log(lat);
    	                   var khatano,plotno,policestn,landtype,Owner,Area_Acre,Area_Hect,distance_htl,crz_category,crz_category_distance,status;
    	                   ...
    	                   /* $.ajax({
    	                       ...
    	                       success: function (data1) 
    	                       {
    	                           ...
    	                           info=info + "<br/><b>Distance From HTL: </b>" + ( distance_htl== null ? "Not Available" : distance_htl)+" mtrs";
    	                           info=info + "<br/><b>CRZ Category: </b>" + ( crz_category== null ? "Not Available" : crz_category);
    	                           info=info + "<br/><b>CRZ Category Distance: </b>" + ( crz_category_distance== null ? "Not Available" : crz_category_distance)+" mtrs";
