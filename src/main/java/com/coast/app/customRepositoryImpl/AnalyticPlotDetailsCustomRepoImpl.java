...
public class AnalyticPlotDetailsCustomRepoImpl implements AnalyticPlotDetailsCustomRepo 
{
	...
	@Override
	public List<Baleshwar_Plots> getPlotDetails_Allvill(String dist, String tehsil, String gp, String village) {
		String jpql = "select '"+dist+"' as distname,tehname,gpname,villname,plotno,crzsts,caasts from coast_oltp."+dist+"_plots where plotno is NOT null and   tehname='" + tehsil + "' and gpname='" + gp + "' and villname='" + village + "'";
		Query queryy = entityManager.createNativeQuery(jpql);
		List<Baleshwar_Plots> list = queryy.getResultList();
		return list;
	}
	...
	@Override
	public List<Baleshwar_Plots> getPlotDetails_gpAll(String dist, String tehsil, String gp) {
		String jpql = "select '"+dist+"' as distname,tehname,gpname,villname,plotno,crzsts,caasts from coast_oltp."+dist+"_plots where plotno is NOT null  and tehname='" + tehsil + "' and gpname='" + gp + "'";
		Query queryy = entityManager.createNativeQuery(jpql);
		List<Baleshwar_Plots> list = queryy.getResultList();
		return list;
	}
	...
	@Override
	public List<Baleshwar_Plots> getPlotDetails_tehsilAll(String dist, String tehsil) {
		String jpql = "select '"+dist+"' as distname,tehname,gpname,villname,plotno,crzsts,caasts from coast_oltp."+dist+"_plots where plotno is NOT null and tehname='" + tehsil + "'";
		Query queryy = entityManager.createNativeQuery(jpql);
		List<Baleshwar_Plots> list = queryy.getResultList();
		return list;
	}
	...
	@Override
	public List<Baleshwar_Plots> getPlotDetails_distAll(String dist) {
		String jpql = "select '"+dist+"' as distname,tehname,gpname,villname,plotno,crzsts,caasts from coast_oltp."+dist+"_plots where plotno is NOT null ";
		Query queryy = entityManager.createNativeQuery(jpql);
		List<Baleshwar_Plots> list = queryy.getResultList();
		return list;
	}
