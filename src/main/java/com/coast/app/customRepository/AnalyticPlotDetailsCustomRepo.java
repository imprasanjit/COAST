...
public interface AnalyticPlotDetailsCustomRepo 
{
	...
	List<Baleshwar_Plots> getPlotDetails_Allvill(String dist, String tehsil, String gp, String village);
	List<Baleshwar_Plots> getPlotDetails_gp(String dist, String tehsil, String gp, String plotno);
	List<Baleshwar_Plots> getPlotDetails_gpAll(String dist, String tehsil, String gp);
	List<Baleshwar_Plots> getPlotDetails_tehsil(String dist, String tehsil, String plotno);
	List<Baleshwar_Plots> getPlotDetails_tehsilAll(String dist, String tehsil);
	List<Baleshwar_Plots> getPlotDetails_dist(String dist, String plotno);
	List<Baleshwar_Plots> getPlotDetails_distAll(String dist);
}
