...
public class ReportController {
														   ...
														   @RequestParam("actionCode")String actionCode,HttpSession session) 
		{
			if (district.equalsIgnoreCase("jajapur")) {
				district="jajpur";
				List<GovtLandSummaryDTO> govtLandSummary = reportService.getGovtLandSummary(actionCode,district, tehsil);
		...
		@ResponseBody
		@RequestMapping(value="/getAllTehsilLandSummary", method = RequestMethod.GET)
		public List<Tehsil_summary> getAllTehsilLandSummary(@RequestParam("district") String district,HttpSession session) 
		{
				List<Tehsil_summary> govtLandSummary = reportService.getAllTehsilLandSummary(district);
				return govtLandSummary;		
		...
		public List<Tehsil_summary> getTehsilAreaSummary(@RequestParam("district") String district,@RequestParam("tehsil") String tehsil,HttpSession session) 
		{
				List<Tehsil_summary> govtLandSummary = reportService.getTehsilAreaSummary(district,tehsil);
				return govtLandSummary;
		}
		...
		@RequestMapping(value="/getAllVillageSummaryReport", method = RequestMethod.GET)
		@ResponseBody
		public List<Village_Summary> getAllVillageAreaSummary(@RequestParam("district") String district,
														   HttpSession session) 
		{

			List<Village_Summary> govtLandSummary = reportService.getAllVillageAreaSummary(district);

			return govtLandSummary;
		}
		@ResponseBody
		@RequestMapping(value="/getDTRSummaryReport", method = RequestMethod.GET)
		public List<BaleshwarLeasPlotsDTO> getDTRSummaryReport(@RequestParam("village") String village) 
		{
			List<BaleshwarLeasPlotsDTO> govtLandSummary = reportService.getDTRSummaryReport(village);
			return govtLandSummary;
